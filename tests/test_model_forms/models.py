...
try:
    ...
    class ImageFile(models.Model):
        ...
        description = models.CharField(max_length=20)  # noqa: DJ012
...
class Photo(models.Model):
    ...
    def save(self, force_insert=False, force_update=False, **kwargs):  # noqa: DJ012
...
class NullableUniqueCharFieldModel(models.Model):
    ...
    slug = models.SlugField(blank=True, null=True)  # noqa: DJ001
    url = models.URLField(blank=True, null=True)  # noqa: DJ001
